...
class TranslationService {
  ...
  getFallbackTranslation(text, targetLang) {
    const fallbacks = {
      en: {
        ...
        'Êtes-vous sûr de vouloir supprimer cette œuvre ?': 'Are you sure you want to delete this artwork?',
        'Attention': 'Warning',
        'Cette action est irréversible. L\'œuvre sera définitivement supprimée de la base de données.': 'This action is irreversible. The artwork will be permanently deleted from the database.',
        'Annuler': 'Cancel',
        'Supprimer définitivement': 'Delete permanently',
        'Suppression...': 'Deleting...',
        'Appuyez sur Échap pour annuler': 'Press Esc to cancel',
        'Supprimer cette œuvre': 'Delete this artwork'
      },
      wo: {
        ...
        'Confirmer la suppression': 'Definee suppression',
        'Êtes-vous sûr de vouloir supprimer cette œuvre ?': 'Danga bëgg supprimer liggéey bii?',
        'Attention': 'Yaa ngi xol',
        'Cette action est irréversible. L\'œuvre sera définitivement supprimée de la base de données.': 'Jëf bii man nañu koo delloo. Liggéey bi dañuy ko supprimer lépp ci base données bi.',
        'Annuler': 'Wutal',
        'Supprimer définitivement': 'Supprimer lépp',
        'Suppression...': 'Dañuy supprimer...',
        'Appuyez sur Échap pour annuler': 'Cuut Échap ngir wutal',
        'Supprimer cette œuvre': 'Supprimer liggéey bii'
      }
    };
  ...
  async translate(text, targetLang) {
    ...
    // Utiliser uniquement les traductions fallback pour éviter les erreurs API
    const translation = this.getFallbackTranslation(text, targetLang);
