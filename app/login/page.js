        ...
        <div className="absolute inset-0 bg-gradient-to-r from-amber-900/80 to-orange-900/60 flex items-center justify-center">
          <div className="text-center text-white p-8">
            <h1 className="text-4xl font-bold mb-4">
              {tSync('Bienvenue au MCN')}
            </h1>
            <p className="text-xl mb-6 text-amber-100">
              {tSync('Découvrez l\'héritage africain dans toute sa splendeur')}
            </p>
            <p className="text-lg text-amber-200">
              {tSync('Une expérience immersive et interactive')}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                {tSync('Accédez à votre espace personnel')}
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={tSync('Votre mot de passe')}
                    required
                  />
                  <button
                    type="button"
